...
- Una función llamada =debo_llevar=, que dada una lista de códigos
  ...
  *Argumento*:
   i. Lista de los códigos de los repartidores disponibles: =[1, 3,
       6, 8]=.
   ii. Lista de tipos de pizzas que los clientes reservaron: =["M",
       "V", "P", "P", "H", "H", "M", "M", "P", "C"]=.
   iii. Cadena de texto con el tipo de pizza a llevar: =P=.
